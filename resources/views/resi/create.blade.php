...
<div class="row">
    <div class="col-md-12">
        <div class="px-3">
            <h2>{{ isset($resi->id) ? "Edit" : "Tambah"  }} Resi</h2>
        </div>
    </div>
    <div class="col-md-12">
        <div class="card">
                ...
                <div class="ps-1">
                    <div class="row" style="margin-top: 25px;">
                        <div class="col-md-4 form-group mb-3">
                            ...
                            <input type="date" name="tgl_resi" id="tgl_resi" class="form-control mt-1 datepicker" placeholder="Masukan No Res" value="{{ isset($resi->resi) ? $resi->resi : ''  }}">
                        </div>
                        <div class="col-md-4 form-group mb-3">
...
<script>
    ...
    const getFormInput = () => {
        // Daerah Asal
        let aa = $('#alamat_pengirim_2').text();
        let at = $('#alamat_penerima_2').text();
