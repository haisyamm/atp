...
<div class="row row-deck row-cards">
            ...
            <div class="card-table table-responsive">
                <table class="table table-vcenter">
                    ...
                    <tbody>
                        <tr>
                            <td class="w-1">
                                <span class="avatar avatar-sm">MA</span>
                            </td>
                        ...
                        <tr>
                            <td class="w-1">
                                <span class="avatar avatar-sm">LO</span>
                            </td>
                            <td class="td-truncate">
                                <div class="text-truncate">
                        ...
                        <tr>
                            <td class="w-1">
                                <span class="avatar avatar-sm">GA</span>
                            </td>
                            <td class="td-truncate">
                                <div class="text-truncate">
                        ...
                        <tr>
                            <td class="w-1">
                                <span class="avatar avatar-sm">SO</span>
                            </td>
                            <td class="td-truncate">
                                <div class="text-truncate">
    ...
    <div class="col-md-6 col-lg-4">
        <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" aria-label="Sponsor Tabler!">
            ...
            <div class="table-responsive">
                <table class="table card-table table-vcenter">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="avatar avatar-sm">GO</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="w-1 pe-0">
